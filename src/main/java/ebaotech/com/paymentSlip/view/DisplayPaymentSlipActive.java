...
public class DisplayPaymentSlipActive {
	
	public void createReport(List<PaymentSlipEntity> listaBoletos) {
		this.createHeaderReport();
		this.createHeaderGrid();
		this.createGrid(listaBoletos);
	}
	
	private void createHeaderReport() {
		System.out.println("");
		System.out.println(" LISTAGEM DE BOLETOS ATIVOS");
		System.out.println("");
	}
